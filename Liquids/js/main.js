...
function spawnParticles(radius, x, y,type) {
    let color = new Box2D.b2ParticleColor(10, 10, 1, 255);
    // flags
    let flags = (0<<0);
...
function init() {
    ...
    createBox(0, -12, 3, .25, true);
    createBox(-2.75, -8, .25, 4, true);
    createBox(2.75, -8, .25, 4, true);
